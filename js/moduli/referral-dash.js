...
export async function renderReferralDash() {
    ...
    if (!referralData.length) {
        tb.innerHTML = '<tr><td colspan="4" class="empty">Nessun referral registrato ancora — viene creato quando un cliente inserisce un codice amico prenotando su wash-hub.it</td></tr>';
        return;
    }
